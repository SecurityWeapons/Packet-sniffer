...
--crypto | Second wlcap argument | Type Scapy for a scapy output, type None for make wlcap output, type True for see the cryptography packets
--filter | Third wlcap argument  | You must dont type it when you dont want to have a filter when you would to have type a filter example: TCP
